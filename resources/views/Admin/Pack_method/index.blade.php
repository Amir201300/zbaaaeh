...
@section('content')
    ...
    <div class="page-wrapper">
                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">طرق التعليف</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th>الصوره</th>
                                        <th>اسم الطريقه بالعربيه</th>
                                        <th>اسم الطريقه بالانجليزيه</th>
                                        <th>الاختيارات</th>
        ...
        <!-- footer -->
        <!-- ============================================================== -->
    @include('Admin.Pack_method.form')
...
@section('script')
    ...
    @include('Admin.Pack_method.script')
